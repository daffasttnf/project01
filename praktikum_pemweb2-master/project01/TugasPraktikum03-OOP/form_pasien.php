  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="text" name="nama_pasien" placeholder="Maukkan Nama" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    <label for="text1" class="col-4 col-form-label">ID Pasien</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="text1" name="kode_pasien" placeholder="Masukkan ID Pasien" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    <label class="col-4">Kelamin</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="text2" name="tanggal_periksa" placeholder="yyyy-mm-dd" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
